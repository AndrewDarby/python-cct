...
shopping_list = ["apples","bread","milk","wine"] # Fill in with some values
...
nutrition_facts = {"sodium":"0.6mg","carbohydrates":"lots","sugar":"just a little"} # Fill in with the nutrition facts from the label

print(nutrition_facts) # Print all the nutrition facts

print(nutrition_facts["sodium"]) # Uncomment this line and pick a value to print individually
